                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                                    <span x-text="$store.userModal.type === 'create' ? 'Create a new account' : 'Update user information'"></span>
                                </p>
                            </div>
                ...
                <div class="relative bg-white dark:bg-zinc-900 border border-red-200 dark:border-red-900/30 rounded-2xl shadow-2xl max-w-sm w-full overflow-hidden"
                    ...
                    <div class="p-8 text-center">
                        <div class="mx-auto w-14 h-14 bg-red-100 dark:bg-red-900/30 rounded-2xl flex items-center justify-center mb-6">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-red-600 dark:text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                            </svg>
                        </div>
                        <h3 class="text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-2">Delete?</h3>
                        <p class="text-sm text-zinc-500 dark:text-zinc-400">
                            Are you sure you want to permanently delete
                            <strong class="text-zinc-700 dark:text-zinc-200" x-text="$store.userModal.form.name"></strong>?
                        </p>
