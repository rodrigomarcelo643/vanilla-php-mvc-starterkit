    ...
    <div class="flex-1 flex flex-col min-h-screen bg-white">
        ...
        <div class="flex items-center justify-between px-6 sm:px-10 h-14 border-b border-zinc-100">
            <a href="<?= BASE_URL ?>/" class="flex items-center gap-2">
                ...
                <span class="text-sm font-semibold text-zinc-900 lg:hidden"><?= APP_NAME ?></span>
            </a>
            <div>
        ...
        <div class="flex-1 flex items-center justify-center px-6 sm:px-10 py-12">
            <div class="w-full max-w-sm">
                ...
                <div class="mb-8">
                    <h1 class="text-2xl font-semibold text-zinc-900 tracking-tight">Create an account</h1>
                    <p class="text-sm text-zinc-500 mt-1.5">Fill in your details to get started for free</p>
                </div>
                ...
                <form id="register-form" novalidate class="space-y-4">
                    ...
                    <div class="relative my-2">
                        ...
                        <div class="relative flex justify-center">
                            <span class="bg-white px-3 text-xs text-zinc-400">or sign up with</span>
                        </div>
                    </div>
