    ...
    <div class="flex-1 flex flex-col min-h-screen bg-white">
        ...
        <div class="flex items-center justify-between px-6 sm:px-10 h-14 border-b border-zinc-100">
            ...
            <div class="lg:ml-auto">
                ...
                <a href="<?= BASE_URL ?>/register" class="ml-2 text-sm font-medium text-zinc-900 hover:underline underline-offset-4">Sign up</a>
            </div>
        </div>
        ...
        <div class="flex-1 flex items-center justify-center px-6 sm:px-10 py-12">
            <div class="w-full max-w-sm">
                ...
                <div class="mb-8">
                    <h1 class="text-2xl font-semibold text-zinc-900 tracking-tight">Sign in</h1>
                    <p class="text-sm text-zinc-500 mt-1.5">Enter your credentials to access your account</p>
                </div>
                ...
                <form id="login-form" novalidate class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="<?= BASE_URL ?>/forgot-password" class="text-xs text-zinc-400 hover:text-zinc-700 transition-colors">Forgot password?</a>
                        </div>
                        <div class="relative">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <button type="button"
                            class="flex items-center justify-center gap-2 h-10 border border-zinc-300 rounded-lg text-sm text-zinc-700 hover:bg-zinc-50 transition-colors">
                ...
                <p class="text-center text-xs text-zinc-400 mt-6">
                    ...
                    <a href="#" class="underline underline-offset-2 hover:text-zinc-700">Terms</a> and
                    <a href="#" class="underline underline-offset-2 hover:text-zinc-700">Privacy Policy</a>.
                </p>
            </div>
        </div>
    </div>
