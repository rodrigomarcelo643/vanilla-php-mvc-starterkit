    ...
    <div class="flex-1 flex flex-col min-h-screen bg-white">
        ...
        <div class="flex-1 flex items-center justify-center px-6 sm:px-10 py-12">
            <div class="w-full max-w-sm">
                ...
                <div class="mb-8">
                    <div class="w-10 h-10 rounded-lg bg-zinc-100 flex items-center justify-center mb-4">
                    ...
                    <h1 class="text-2xl font-semibold text-zinc-900 tracking-tight">Set new password</h1>
                    <p class="text-sm text-zinc-500 mt-1.5">Must be at least 8 characters.</p>
                </div>
                ...
                <form id="rp-form" novalidate class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            <input type="password" name="password" id="rp-password"
                                class="w-full h-10 px-3.5 pr-10 text-sm border border-zinc-300 rounded-lg bg-white text-zinc-900 placeholder-zinc-400
                    ...
                    <div>
                        <div class="flex gap-1 mb-1">
                            <div id="str-1" class="h-1 flex-1 rounded-full bg-zinc-200 transition-colors duration-300"></div>
                            <div id="str-2" class="h-1 flex-1 rounded-full bg-zinc-200 transition-colors duration-300"></div>
                            <div id="str-3" class="h-1 flex-1 rounded-full bg-zinc-200 transition-colors duration-300"></div>
                            <div id="str-4" class="h-1 flex-1 rounded-full bg-zinc-200 transition-colors duration-300"></div>
                        </div>
                        <p id="str-label" class="text-xs text-zinc-400"></p>
                    </div>
