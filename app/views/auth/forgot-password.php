<div class="min-h-screen flex fade-in">
    ...
    <div class="flex-1 flex flex-col min-h-screen bg-white">
        ...
        <div class="flex items-center justify-between px-6 sm:px-10 h-14 border-b border-zinc-100">
            <a href="<?= BASE_URL ?>/" class="flex items-center gap-2 lg:hidden">
                <div class="w-6 h-6 rounded bg-zinc-900 flex items-center justify-center">
                    <svg class="w-3 h-3 text-white" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                    </svg>
                </div>
                <span class="text-sm font-semibold text-zinc-900"><?= APP_NAME ?></span>
            </a>
            <div class="lg:ml-auto">
                <span class="text-sm text-zinc-500">Remember your password?</span>
                <a href="<?= BASE_URL ?>/login" class="ml-2 text-sm font-medium text-zinc-900 hover:underline underline-offset-4">Sign in</a>
            </div>
        </div>
        ...
        <div class="flex-1 flex items-center justify-center px-6 sm:px-10 py-12">
            <div class="w-full max-w-sm">
                ...
                <div class="mb-6 px-4 py-3.5 rounded-lg bg-red-50 border border-red-200 flex items-start gap-3">
                    ...
                    <p class="text-sm text-red-700">This reset link has <strong>expired or is invalid</strong>. Please request a new one below.</p>
                </div>
                <?php endif; ?>

                <!-- Sent state (hidden by default, shown via JS) -->
                <div id="fp-success" class="hidden text-center">
                    <div class="w-14 h-14 rounded-full bg-green-50 border border-green-200 flex items-center justify-center mx-auto mb-5">
                        <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                        </svg>
                    </div>
                    <h2 class="text-xl font-semibold text-zinc-900 mb-2">Check your email</h2>
                    <p class="text-sm text-zinc-500 mb-6">We sent a password reset link to <strong id="fp-sent-email" class="text-zinc-700"></strong>. The link expires in 1 hour.</p>
                    <a href="<?= BASE_URL ?>/login" class="text-sm font-medium text-zinc-900 hover:underline underline-offset-4">← Back to sign in</a>
                </div>

                <!-- Form state -->
                <div id="fp-form-wrap">
                    <p class="mb-6">
                        <a href="<?= BASE_URL ?>/login" class="inline-flex items-center gap-1.5 text-sm text-zinc-500 hover:text-zinc-900 transition-colors">
                    ...
                    <div class="mb-8 flex items-center gap-3">
                        <div class="w-10 h-10 rounded-lg bg-zinc-100 flex items-center justify-center shrink-0">
                            <svg class="w-5 h-5 text-zinc-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"/>
                            </svg>
                        </div>
                        <div>
                            <h1 class="text-2xl font-semibold text-zinc-900 tracking-tight">Forgot password?</h1>
                            <p class="text-sm text-zinc-500 mt-0.5">Enter your email and we'll send you a reset link.</p>
                        </div>
                    </div>
                    ...
                    <form id="fp-form" novalidate class="space-y-4">
                        <div class="space-y-1.5">
                            ...
                            <input type="email" name="email" id="fp-email"
                                class="w-full h-10 px-3.5 text-sm border border-zinc-300 rounded-lg bg-white text-zinc-900 placeholder-zinc-400
