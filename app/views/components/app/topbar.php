...
<script>(function(){
    ...
    if(dk){ s.style.background='#18181b'; s.style.borderBottomColor='#27272a'; }
    ...
    <div style="display:flex;align-items:center;gap:12px;flex-shrink:0">
        ...
        <div style="display:flex;align-items:center;gap:6px">
            <div class="skeleton-base" style="width:64px;height:13px;border-radius:3px"></div>
    ...
    <div class="flex items-center gap-3 shrink-0">
        ...
        <nav class="hidden sm:flex items-center gap-1.5 text-sm">
            <a href="<?= BASE_URL ?>/app/home"
                class="text-zinc-400 dark:text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors whitespace-nowrap">My
                Account</a>
            <svg class="w-3.5 h-3.5 text-zinc-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
    ...
    <div class="flex items-center gap-1 shrink-0" x-data="{ dropOpen: false, notifOpen: false }">
        ...
        <div class="relative">
            ...
            <div x-show="notifOpen" @click.away="notifOpen = false"
                ...
                <div class="flex items-center justify-between px-4 py-3 border-b border-zinc-100 dark:border-zinc-800">
                    ...
                    <span
                        class="text-xs bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 font-medium px-1.5 py-0.5 rounded-full">2</span>
                </div>
                <?php foreach ([
        ...
        <div class="relative">
            <button @click="dropOpen = !dropOpen"
                ...
                <span
                    class="hidden sm:block text-sm font-medium text-zinc-700 dark:text-zinc-300 whitespace-nowrap"><?= htmlspecialchars($u['name'] ?? '') ?></span>
