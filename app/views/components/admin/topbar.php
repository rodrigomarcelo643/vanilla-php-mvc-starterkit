...
<header class="h-14 bg-white border-b border-zinc-200 flex items-center px-4 shrink-0 z-20 gap-4">
    ...
    <div class="flex items-center gap-3 shrink-0">
        ...
        <nav class="hidden sm:flex items-center gap-1.5 text-sm">
            <a href="<?= BASE_URL ?>/dashboard" class="text-zinc-400 hover:text-zinc-700 transition-colors whitespace-nowrap">Admin</a>
        ...
        <div class="relative">
            ...
            <div x-show="notifOpen" @click.away="notifOpen = false"
                ...
                <div class="flex items-center justify-between px-4 py-3 border-b border-zinc-100">
                    ...
                    <span class="text-xs bg-zinc-100 text-zinc-600 font-medium px-1.5 py-0.5 rounded-full">3</span>
                </div>
                <?php
                $notifs = [
                ...
                <div class="flex items-start gap-3 px-4 py-3 hover:bg-zinc-50 transition-colors cursor-pointer border-b border-zinc-50 last:border-0">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm text-zinc-800"><?= $n['title'] ?></p>
                        <p class="text-xs text-zinc-400 mt-0.5"><?= $n['time'] ?></p>
                    </div>
                </div>
                <?php endforeach; ?>
                <div class="px-4 py-2.5 border-t border-zinc-100">
                    <button class="text-xs text-zinc-500 hover:text-zinc-900 transition-colors w-full text-center">
        ...
        <div class="relative">
            ...
            <div x-show="dropOpen" @click.away="dropOpen = false"
                ...
                <div class="px-3 py-2 border-b border-zinc-100 mb-1">
                    <p class="text-xs font-semibold text-zinc-900 truncate" data-user-name><?= htmlspecialchars($u['name'] ?? 'Admin') ?></p>
