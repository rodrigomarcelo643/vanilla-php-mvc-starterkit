...
<section class="bg-white border-b border-zinc-200 py-14 sm:py-20">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 fade-in">
        ...
        <h1 class="text-3xl sm:text-4xl font-bold text-zinc-900 leading-tight mb-4 max-w-2xl">
            Built for developers who value simplicity.
        </h1>
        <p class="text-base text-zinc-500 max-w-xl leading-relaxed">
...
<!-- Mission -->
<section class="bg-zinc-50 border-b border-zinc-200 py-14 sm:py-20">
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div class="fade-in">
                <p class="text-xs font-semibold uppercase tracking-widest text-zinc-400 mb-3">Our mission</p>
                <h2 class="text-2xl font-bold text-zinc-900 mb-4">Less boilerplate, more building.</h2>
            ...
            <div class="grid grid-cols-2 gap-4 fade-in">
                ...
                <div class="bg-white border border-zinc-200 rounded-xl p-5">
                    <p class="text-2xl font-bold text-zinc-900"><?= $s[0] ?></p>
...
<section class="bg-white border-b border-zinc-200 py-14 sm:py-20">
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        <div class="max-w-xl mb-10 fade-in">
            ...
            <h2 class="text-2xl font-bold text-zinc-900">What's under the hood.</h2>
        </div>
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            foreach ($stack as $s): ?>
            <div class="bg-zinc-50 border border-zinc-200 rounded-xl p-5 fade-in">
                <div class="w-8 h-8 rounded-lg bg-zinc-900 flex items-center justify-center mb-3">
...
<section class="bg-white py-14 sm:py-20">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 text-center fade-in">
        <h2 class="text-2xl font-bold text-zinc-900 mb-3">Ready to get started?</h2>
        <p class="text-sm text-zinc-500 mb-6">Create your account and start building today.</p>
