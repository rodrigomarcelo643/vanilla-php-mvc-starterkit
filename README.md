...
### A lightweight PHP MVC starter kit with admin panel, authentication, and role-based routing — built without frameworks.
...
Starter Kit is a clean, zero-dependency PHP boilerplate designed to get projects off the ground fast. It provides a structured MVC foundation with:
...
- **Tailwind CSS + Alpine.js** — Modern UI without a heavy build pipeline
...
Project/
├── app/
│   ├── config/         # App & database config (reads from .env)
│   ├── controllers/    # MVC controllers
│   ├── core/           # Router, Model, Auth, Session, Database
